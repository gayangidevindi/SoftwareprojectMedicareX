    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-content">
        <div className="welcome-section">
          <h1 className="welcome-title">Supplier Dashboard</h1>
          <p className="welcome-subtitle">
            Manage logistics and supply operations
          </p>
        </div>
        ...
        <div className="info-card">
          ...
          <div className="info-body">
            ...
            <div className="info-row">
              ...
              <span className="info-value role-badge role-supplier">
                 Supplier
              </span>
            </div>
            <div className="info-row">
        ...
        <div className="actions-grid">
          <div className="action-card">
            ...
            <h3 className="action-title">Orders</h3>
            <p className="action-description">
              View and process supply orders
            </p>
          </div>

          <div className="action-card">
            <div className="action-icon"></div>
            <h3 className="action-title">Deliveries</h3>
            <p className="action-description">
          ...
          <div className="action-card">
            <div className="action-icon"></div>
            <h3 className="action-title">Pharmacies</h3>
            <p className="action-description">
