      ...
      <div className="dashboard-content">
        ...
        <div className="info-card">
          ...
          <div className="info-body">
            ...
            <div className="info-row">
              ...
              <span className="info-value role-badge role-customer">
                 Customer
              </span>
            </div>
            <div className="info-row">
        ...
        <div className="actions-grid">
          <div className="action-card">
            ...
            <h3 className="action-title">Browse Products</h3>
            <p className="action-description">
              View available medicines and products
            </p>
          </div>

          <div className="action-card">
            <div className="action-icon"></div>
            <h3 className="action-title">My Orders</h3>
            <p className="action-description">
          ...
          <div className="action-card">
            <div className="action-icon"></div>
            <h3 className="action-title">Payment Methods</h3>
            <p className="action-description">
